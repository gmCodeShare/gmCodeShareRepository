...
button1.on("click", () => {
  ...
  utils.RTS.sendData("slide-28a7788bcedd", {
    num,
    num2,
    num3,
    num4,
...
/*
{"compTotals":{"textbox":2,"table":1,"button":1},"stage":"Launch","lessonInfo":"9 M2 TC L16 - Using Lines to Model Bivariate Quantitative Data","teacherView":false,"layout":"one col"}
*/
