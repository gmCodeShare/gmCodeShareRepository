const {
  ...
  cc_sharewithclass_2fb066fd6215_studentanswers1,
  feedback1,
} = components;
...
utils.RTS.on("datachange", "slide-0f4cf0884e2b", (register) => {
  ...
  ggb3.instance.evalCommand("data={}");
...
/*
{"compTotals":{"geogebra":3,"separator":1,"buttongroup":1,"textbox":2,"radiogroup":1,"sharewithclass":1},"stage":"Learn","lessonInfo":"9 M2 TC L15 - Relationships Between Quantitative Variables","teacherView":false,"layout":"two col"}
*/
