...
buttonGroup1.on("click:1", () => {
  ...
  //if students do NOT write two linear inequalities, tell them!
    ...
    text5.updateData({ text: "Be sure to write two linear inequalities." });
  }
});
...
/*
{"compTotals":{"geogebra":1,"textbox":6,"input":2,"buttongroup":1},"stage":"Learn","lessonInfo":"9 M2 TB L12 - Solution Sets of Systems of Linear Inequalities","teacherView":false,"layout":"two col"}
*/
