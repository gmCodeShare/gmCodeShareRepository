...
button1.on("click", () => {
  ...
  utils.RTS.sendData("slide-290b837ee12a", {
    num,
    num2,
    num3,
    num4,
...
/*
{"compTotals":{"textbox":2,"table":1,"button":1},"stage":"Launch","lessonInfo":"9 M2 TC L17 - Modeling Relationships with a Line","teacherView":false,"layout":"one col"}
*/
