...
if (data.innerData) {
  ...
  if (slide4total < 6) {
    ggb1.instance.evalCommand(`Slide7A=(${slide4x1},${slide4y1})`);
    ggb1.instance.setVisible('Slide7A', true);
  }
  if (slide4total >= 6) {
    ggb1.instance.setVisible('Slide7A', false);
  }
  if (slide4total2 < 6) {
    ggb1.instance.evalCommand(`Slide7B=(${slide4x2},${slide4y2})`);
    ggb1.instance.setVisible('Slide7B', true);
  }
  if (slide4total2 >= 6) {
    ggb1.instance.setVisible('Slide7B', false);
  }
  if (slide4total3 < 6) {
    ggb1.instance.evalCommand(`Slide7C=(${slide4x3},${slide4y3})`);
    ggb1.instance.setVisible('Slide7C', true);
  }
  if (slide4total3 >= 6) {
    ggb1.instance.setVisible('Slide7C', false);
  }
} else {
  ggb1.instance.setVisible('Slide7A', false);
  ggb1.instance.setVisible('Slide7B', false);
...
/*
{"compTotals":{"geogebra":1,"textbox":1,"submit":1,"separator":1,"sharewithclass":1},"stage":"Learn","lessonInfo":"9 M2 TA L04 - Solution Sets of Linear Inequalities in Two Variables","teacherView":false,"layout":"two col"}
*/
