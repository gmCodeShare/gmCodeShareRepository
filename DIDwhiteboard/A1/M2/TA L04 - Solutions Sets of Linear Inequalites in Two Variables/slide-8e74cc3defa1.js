const { text1, text2, table1, button1, feedback1 } = components;
...
const id = 'slide-c4109ff810fa';
let prevText =
  getFromSlide(id, 'cc_submit_c997e1f0e31b_input1.data.text', '') || '';

if (!prevText) {
  prevText = `\\text\\color{707070}{\[no input yet on slide ${getSlideNum(
    id
  )}\]}`;
}

text2.updateData({ text: `$${prevText}$` });
...
/*
{"compTotals":{"textbox":3,"table":1,"button":1},"stage":"Learn","lessonInfo":"9 M2 TA L04 - Solution Sets of Linear Inequalities in Two Variables","teacherView":false,"layout":"one col"}
*/
