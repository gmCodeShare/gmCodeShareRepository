...
autorun(() => {
  ...
  if (radio1.data.selected === "0" && ggb1.instance.getValue("show")) {
    ggb1.instance.setVisible("slide17a", true);
    ggb1.instance.setVisible("slide17b", false);
    ggb1.instance.setVisible("slide17c", false);
    ggb1.instance.setVisible("slide17d", false);
  }
  if (radio1.data.selected === "1" && ggb1.instance.getValue("show")) {
    ggb1.instance.setVisible("slide17a", false);
    ggb1.instance.setVisible("slide17b", true);
    ggb1.instance.setVisible("slide17c", false);
    ggb1.instance.setVisible("slide17d", false);
  }
  if (radio1.data.selected === "2" && ggb1.instance.getValue("show")) {
    ggb1.instance.setVisible("slide17a", false);
    ggb1.instance.setVisible("slide17b", false);
    ggb1.instance.setVisible("slide17c", true);
    ggb1.instance.setVisible("slide17d", false);
  }
  if (radio1.data.selected === "3" && ggb1.instance.getValue("show")) {
    ...
    ggb1.instance.setVisible("slide17b", false);
    ggb1.instance.setVisible("slide17c", false);
    ggb1.instance.setVisible("slide17d", true);
  }
});
...
/*
{"compTotals":{"geogebra":1,"textbox":3,"radiogroup":1,"submit":1,"separator":2,"buttongroup":1},"stage":"Learn","lessonInfo":"9 M4 TB L11 - Graphing Quadratic Functions from Factored Form","teacherView":false,"layout":"two col"}
*/
