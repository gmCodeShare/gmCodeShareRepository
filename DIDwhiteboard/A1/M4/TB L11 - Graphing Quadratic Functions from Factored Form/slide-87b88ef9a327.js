...
autorun(() => {
  ...
  if (radio1.data.selected === "0" && ggb1.instance.getValue("show")) {
    ggb1.instance.setVisible("slide18a", true);
    ggb1.instance.setVisible("slide18b", false);
    ggb1.instance.setVisible("slide18c", false);
    ggb1.instance.setVisible("slide18d", false);
  }
  if (radio1.data.selected === "1" && ggb1.instance.getValue("show")) {
    ggb1.instance.setVisible("slide18a", false);
    ggb1.instance.setVisible("slide18b", true);
    ggb1.instance.setVisible("slide18c", false);
    ggb1.instance.setVisible("slide18d", false);
  }
  if (radio1.data.selected === "2" && ggb1.instance.getValue("show")) {
    ggb1.instance.setVisible("slide18a", false);
    ggb1.instance.setVisible("slide18b", false);
    ggb1.instance.setVisible("slide18c", true);
    ggb1.instance.setVisible("slide18d", false);
  }
  if (radio1.data.selected === "3" && ggb1.instance.getValue("show")) {
    ...
    ggb1.instance.setVisible("slide18b", false);
    ggb1.instance.setVisible("slide18c", false);
    ggb1.instance.setVisible("slide18d", true);
  }
});
