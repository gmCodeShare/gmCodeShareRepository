...
autorun(() => {
  ...
  if (radio1.data.selected === "0" && ggb1.instance.getValue("show")) {
    ggb1.instance.setVisible("slide16a", true);
    ggb1.instance.setVisible("slide16b", false);
    ggb1.instance.setVisible("slide16c", false);
    ggb1.instance.setVisible("slide16d", false);
  }
  if (radio1.data.selected === "1" && ggb1.instance.getValue("show")) {
    ggb1.instance.setVisible("slide16a", false);
    ggb1.instance.setVisible("slide16b", true);
    ggb1.instance.setVisible("slide16c", false);
    ggb1.instance.setVisible("slide16d", false);
  }
  if (radio1.data.selected === "2" && ggb1.instance.getValue("show")) {
    ggb1.instance.setVisible("slide16a", false);
    ggb1.instance.setVisible("slide16b", false);
    ggb1.instance.setVisible("slide16c", true);
    ggb1.instance.setVisible("slide16d", false);
  }
  if (radio1.data.selected === "3" && ggb1.instance.getValue("show")) {
    ...
    ggb1.instance.setVisible("slide16b", false);
    ggb1.instance.setVisible("slide16c", false);
    ggb1.instance.setVisible("slide16d", true);
  }
});
