...
autorun(() => {
  if (controls.current == now + 1 && ggb2.data.cmdStrings?.length) {
    utils.RTS.sendData("slide-5fa491f600ef", {
      doodles: [...ggb2.data.cmdStrings],
    });
  }
});
...
/*
{"compTotals":{"textbox":2,"geogebra":2,"separator":1,"buttongroup":1},"stage":"Learn","lessonInfo":"9 M3 TB L07 - Exploring Key Features of a Function and Its Graph","teacherView":false,"layout":"T layout"}
*/
