...
const incData =
  getFromSlide("slide-6eb90322dfa7", "ggb1.innerData", false) || false;
if (incData) {
  const params = [
    [incData.lowParam1, incData.highParam1],
    [incData.lowParam2, incData.highParam2],
  ...
  params.forEach((paramPair) => {
    ...
    ggb1.instance.setFilling(newPLine, 0.3);
...
const decData =
  getFromSlide("slide-6eb90322dfa7", "ggb2.innerData", false) || false;
if (decData) {
  const params = [
    [decData.lowParam1, decData.highParam1],
