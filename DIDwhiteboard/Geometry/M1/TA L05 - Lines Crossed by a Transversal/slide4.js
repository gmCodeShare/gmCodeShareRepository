...
const {
  ...
  text2,
  select2,
  cc_sharewithclass_e5171d8b0d3c_textbox1: shareText1,
  cc_sharewithclass_e5171d8b0d3c_input1: shareInput1,
  cc_sharewithclass_e5171d8b0d3c_button1: shareButton1,
} = components;
...
ggb1.instance.registerObjectUpdateListener('time', revealShare);
