...
select1.on('change', (selected) => {
  if (select1.data.selected.includes('0')) {
    ...
    ggb1.instance.setColor('q23', 130, 63, 152);
    ggb1.instance.setColor('q33', 0, 129, 57);
    ggb1.instance.setColor('q43', 255, 255, 255);
    ggb1.instance.setTextValue('q13Text', 'green');
    ggb1.instance.setTextValue('q23Text', 'purple');
    ggb1.instance.setTextValue('q33Text', 'green');
