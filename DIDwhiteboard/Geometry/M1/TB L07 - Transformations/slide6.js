...
slide.on('firstload', () => {
  ...
  ggb3.instance.setValue('showSetA', false);
  ggb4.instance.setValue('showSetA', false);
...
ggb4.instance.registerObjectClickListener('XBox', backToGGB3);
...
ggb3.instance.registerObjectClickListener('q1ExpandBox', expandQ1Three);
ggb3.instance.registerObjectClickListener('q2ExpandBox', expandQ2Three);
ggb3.instance.registerObjectClickListener('q3ExpandBox', expandQ3Three);
ggb3.instance.registerObjectClickListener('q4ExpandBox', expandQ4Three);

ggb1.instance.registerClientListener(focusIndicatorsGGB1);
ggb2.instance.registerClientListener(focusIndicatorGGB2);
ggb3.instance.registerClientListener(focusIndicatorsGGB3);
...
function focusIndicatorsGGB3(a) {
  if (a.type == 'select') {
    if (a.target == 'q1ExpandBox') {
      ggb3.instance.setVisible('q1FocusIndicator', true);
    } else {
      ggb3.instance.setVisible('q1FocusIndicator', false);
    }
    if (a.target == 'q2ExpandBox') {
      ggb3.instance.setVisible('q2FocusIndicator', true);
    } else {
      ggb3.instance.setVisible('q2FocusIndicator', false);
    }
    if (a.target == 'q3ExpandBox') {
      ggb3.instance.setVisible('q3FocusIndicator', true);
    } else {
      ggb3.instance.setVisible('q3FocusIndicator', false);
    }
    if (a.target == 'q4ExpandBox') {
      ggb3.instance.setVisible('q4FocusIndicator', true);
    } else {
      ggb3.instance.setVisible('q4FocusIndicator', false);
    }
  }
  if (a.type == 'deselect') {
    turnOffExpandIndicators();
...
function expandQ1Three() {
  ...
  ggb4.instance.evalCommand('CenterView(Q1Centroid)');
}

function expandQ2Three() {
  turnOffExpandIndicators();
  ggb3.updateData({ visible: false });
  ggb4.updateData({ visible: true });
  ...
  ggb4.instance.setValue('showQ3', false);
  ggb4.instance.setValue('showQ4', false);
  ggb4.instance.evalCommand('CenterView(Q2Centroid)');
}

function expandQ3Three() {
  turnOffExpandIndicators();
  ggb3.updateData({ visible: false });
  ggb4.updateData({ visible: true });
  ggb4.instance.setValue('showQ1', false);
  ...
  ggb4.instance.setValue('showQ4', false);
  ggb4.instance.evalCommand('CenterView(Q3Centroid)');
}

function expandQ4Three() {
  turnOffExpandIndicators();
  ggb3.updateData({ visible: false });
  ggb4.updateData({ visible: true });
  ggb4.instance.setValue('showQ1', false);
  ...
  ggb4.instance.evalCommand('CenterView(Q4Centroid)');
}

function updateTimes() {
  ggb2.instance.setValue('time', ggb1.instance.getValue('time'));
  ggb3.instance.setValue('time', ggb1.instance.getValue('time'));
  ggb4.instance.setValue('time', ggb1.instance.getValue('time'));
}
...
select1.on('change', (selected) => {
  if (select1.data.selected.includes('0')) {
    ...
    for (i = 0, L = segListB.length; i < L; i++) {
      ggb3.instance.setLabelVisible(segListB[i], true);
      ggb4.instance.setLabelVisible(segListB[i], true);
    }
  } else {
    for (i = 0, L = segListA.length; i < L; i++) {
    ...
    for (i = 0, L = segListB.length; i < L; i++) {
      ggb3.instance.setLabelVisible(segListB[i], false);
      ggb4.instance.setLabelVisible(segListB[i], false);
    }
  }
  if (select1.data.selected.includes('1')) {
    ggb1.instance.setValue('showAngles', true);
    ggb2.instance.setValue('showAngles', true);
    ggb3.instance.setValue('showAngles', true);
    ggb4.instance.setValue('showAngles', true);
  } else {
    ggb1.instance.setValue('showAngles', false);
    ggb2.instance.setValue('showAngles', false);
    ggb3.instance.setValue('showAngles', false);
    ggb4.instance.setValue('showAngles', false);
  }
});
