...
fib1.on('change', ({ values }) => {
  ...
  const squaredNum = result.value ** 2; // slide specific
  // const roundedNum = cubedNum.toFixed(6);
  const roundedNum = round(squaredNum, safeRound); // slide specific
...
/*
{"compTotals":{"geogebra":1,"separator":4,"textbox":5,"buttongroup":2,"fillblank":2,"button":1},"stage":"Learn","lessonInfo":"8 M1 TE L21 - Approximate Values of Roots and π²","teacherView":false,"layout":"two col"}
*/
