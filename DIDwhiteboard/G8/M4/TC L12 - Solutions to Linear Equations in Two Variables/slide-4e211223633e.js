const {
  ...
  cc_sharewithclass_df49a07d0b76_button1: shareButton2,
...
function show() {
  ...
  let num7 = table1.getCell(1, 1).value;
  ...
  let nums = [num, num2, num7, num3, num4, num5, num6];
  ...
  utils.RTS.sendData("slide-4e211223633e", {
    pointA: [-10, num],
    pointB: [num2, num7],
    pointC: [num3, num4],
    pointD: [num5, num6],
