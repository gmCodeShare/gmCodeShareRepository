const { ggb1, feedback1, text1, table1, textDisplay6, button1 } = components;
...
/**
 * record of GGB changes - 6/3 CW
 *
 * SI/Time	  Green Check Vectors		Red X Vectors
 *   1/0.5	 		p					            q
 *   2/1.5	 		m					            s
 *   3/2.5	 		k					            u_1
 *   4/3.5	 		i					            w_1
...
/*
{"compTotals":{"geogebra":1,"textbox":3,"table":1,"button":1},"stage":"Learn","lessonInfo":"8 M6 TA L01 - Motion and Speed","teacherView":false,"layout":"two col"}
*/
