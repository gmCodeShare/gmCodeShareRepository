const { select1, ggb1, buttonGroup1, media1, media2, select2, fib1 } =
	components;
...
/////////////////////  VIDEO LOAD  /////////////////////
//recap context and move to equations
media1.on("ready", ({ data: vid }) => {
	vid.play();
	//pause for select component - which is first number
	vid.bind("betweentimes", 45, 46, (withinInterval) => {
		if (withinInterval) {
			vid.pause();
			select2.setVisible(true);
		}
	});
	//when submitted and correct
	vid.bind("end", () => {
