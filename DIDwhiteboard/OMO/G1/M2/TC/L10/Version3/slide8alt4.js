...
ggb1.instance.registerObjectUpdateListener('jiggleTime', jiggleTimeListener);
ggb1.instance.registerObjectUpdateListener('jiggleBlank1Time', jiggleBlank1TimeListener);
ggb1.instance.registerObjectUpdateListener('jiggleBlank2Time', jiggleBlank2TimeListener);
ggb1.instance.registerObjectUpdateListener('jiggleBlank3Time', jiggleBlank3TimeListener);
ggb1.instance.registerObjectUpdateListener('correctTime', correctTimeListener);
ggb1.instance.registerObjectUpdateListener('circleBlank1Time', circleBlank1TimeListener);
ggb1.instance.registerObjectUpdateListener('circleBlank3Time', circleBlank3TimeListener);
ggb1.instance.registerObjectUpdateListener('blank2Num', blank2NumListener);
...
function onInit() {
  if (!ggb1.data.init) {
    ...
    ggb1.instance.setVisible('InputBox1', true);
...
buttonGroup1.on('click:1', () => {
  ggb1.instance.setVisible('greenCheck', false);
  ggb1.instance.setVisible('CubeXWrongEnd', false);
  ggb1.instance.setValue('circleBlank1Time', 0);
  ggb1.instance.setValue('circleBlank3Time', 0);
  let inputVal = ggb1.instance.getValue('blank2Num');
  switch (inputVal) {
    case correctNum2:
      ...
      ggb1.instance.setValue('correctTime', 0);
      ggb1.instance.setAnimating('correctTime', true);
      ggb1.instance.setVisible('greenCheck', true);
    ...
    default:
      ...
      ggb1.instance.evalCommand('circle1=Circle((' + correctNum1 + '-0.5,0.5),0.5)');
      ggb1.instance.setFixed('circle1', true, false);
      ggb1.instance.setColor('circle1', 130, 63, 152);
      for (let i = 0, L = arcList.length; i < L; i++) {
        ggb1.instance.setVisible(arcList[i], false);
        ggb1.instance.setColor(arcList[i], 130, 63, 152);
      }
      for (let i = 0, L = inputVal; i < L; i++) {
        ggb1.instance.setVisible(arcList[correctNum1 + i - 1], true);
      }
      ggb1.instance.setValue('wrongAddend', correctNum1 + inputVal - 1);
      ggb1.instance.setVisible('CubeXWrongEnd', true);
      // ggb1.instance.stopAnimation();
      ...
      // ggb1.instance.setAnimating('circleBlank1Time', true);
...
buttonGroup1.on('click:2', () => {
  ggb1.instance.setVisible('greenCheck', false);
  ggb1.instance.setVisible('CubeXWrongEnd', false);
  ggb1.instance.setValue('blank2Num', '?');
  ggb1.instance.setValue('circleBlank1Time', 0);
  ggb1.instance.setValue('circleBlank3Time', 0);
  ...
  for (let i = 0, L = arcList.length; i < L; i++) {
    ggb1.instance.setVisible(arcList[i], false);
    ggb1.instance.setColor(arcList[i], 0, 127, 175);
  }
...
function jiggleBlank3TimeListener() {
  if (ggb1.instance.getValue('jiggleBlank3Time') == 1) {
    ggb1.instance.setAnimating('jiggleBlank3Time', false);
  }
}

function correctTimeListener() {
  if (ggb1.instance.getValue('correctTime') == 1) {
    ggb1.instance.setAnimating('correctTime', false);
    controls.next();
  }
}

function blank2NumListener() {
  ggb1.instance.setVisible('greenCheck', false);
  if (ggb1.instance.getValue('blank2Num') >= 0 && ggb1.instance.getValue('blank2Num') <= 99) {
    buttonGroup1.updateSingleButton({ disabled: false }, 1);
  }
}

function circleBlank1TimeListener() {
  if (ggb1.instance.getValue('circleBlank1Time') == 1) {
    ggb1.instance.stopAnimation();
    ggb1.instance.setAnimating('circleBlank1Time', false);
    ggb1.instance.setAnimating('circleBlank3Time', true);
    ggb1.instance.setValue('circleBlank3Time', 0);
    ggb1.instance.startAnimation();
  }
}

function circleBlank3TimeListener() {
  if (ggb1.instance.getValue('circleBlank3Time') == 1) {
    ggb1.instance.setAnimating('circleBlank3Time', false);
  }
}
