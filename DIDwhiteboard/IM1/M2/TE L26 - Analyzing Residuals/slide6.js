...
utils.RTS.on("datachange", "slide-4a8df8945050", (register) => {
...
autorun(() => {
  ...
  const { setValue } = ggb1.instance;
  setValue("lineOfBestFit", showLine);
  setValue("residuals", showResiduals);
  setValue("equation", showLineEQ);
