...
button2.on("click", () => {
  ...
  function createPoint() {
    const randX = -11 + Math.random() * 22;
    const randY = -11 + Math.random() * 22;
    ...
    ggb1.instance.evalCommand(
      `SetValue(randPointsList, Append(randPointsList, ${newPoint}))`
    );
    ggb1.instance.setTextValue(
      "randPointsString",
      ggb1.instance.getValueString("randPointsList") + ""
    );
  }
  let ms = 200;
  function timeout() {
