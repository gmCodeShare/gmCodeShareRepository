...
if (total < 6 && content.data.rows[0][0].value != "") {
  ...
  table1.updateCell(0, 2, {
    value: `(${content.data.rows[0][0].value}, ${content.data.rows[0][2].value})`,
  });
}
...
if (total2 < 6 && content2.data.rows[0][0].value != "") {
  ...
  table1.updateCell(1, 2, {
    value: `(${content2.data.rows[0][0].value}, ${content2.data.rows[0][2].value})`,
  });
}
...
if (total3 < 6 && content2.data.rows[1][0].value != "") {
  ...
  table1.updateCell(2, 2, {
    value: `(${content2.data.rows[1][0].value}, ${content2.data.rows[1][2].value})`,
  });
}
...
if (total4 < 6 && content3.data.rows[0][0].value != "") {
  ...
  table1.updateCell(3, 2, {
    value: `(${content3.data.rows[0][0].value}, ${content3.data.rows[0][1].value})`,
  });
}
...
if (total5 < 6 && content3.data.rows[1][0].value != "") {
  ...
  table1.updateCell(4, 2, {
    value: `(${content3.data.rows[1][0].value}, ${content3.data.rows[1][1].value})`,
  });
}
...
if (total6 < 6 && content3.data.rows[2][0].value != "") {
  ...
  table1.updateCell(5, 2, {
    value: `(${content3.data.rows[2][0].value}, ${content3.data.rows[2][1].value})`,
  });
}
