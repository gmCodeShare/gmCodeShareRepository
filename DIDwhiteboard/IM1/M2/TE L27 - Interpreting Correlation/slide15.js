...
// have to code around new y min/max for residual plot
// also fix select comp as per earlier lesson (able to show residuals and not best fit line)
...
utils.RTS.on("datachange", "slide-9ca5bc851122", (register) => {
...
utils.RTS.on("datachange", "slide-ffd0bc2076d0", (register) => {
  ...
  // console.log(table3.data.rows.length);
  const lastRegister = discardOldResponses(register).reverse();
