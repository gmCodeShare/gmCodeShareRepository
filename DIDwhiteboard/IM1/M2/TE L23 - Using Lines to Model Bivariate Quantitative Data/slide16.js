...
createLineSafe(equa, ggb1);
const prevInput2 = getPrevInput(`slide-97ff43948160`, "input1");
const equa2 = prevInput1.data.text;
createLineSafe(equa2, ggb2);

function createLineSafe(inp, ggbComp) {
  ggbComp.instance.evalLaTeX(`dummyObjectForThisCode: ${inp}`);
  ggbComp.instance.setVisible("dummyObjectForThisCode", false);
  if (ggbComp.instance.getObjectType("dummyObjectForThisCode") == "line") {
    ggbComp.instance.evalLaTeX(`g: ${inp}`);
    ggbComp.instance.setVisible("g", false);
    ggbComp.instance.evalCommand("studentLine=g");
    ggbComp.instance.setVisible("shortenedStudentLine", true);
  }
  ggbComp.instance.deleteObject("dummyObjectForThisCode");
}
