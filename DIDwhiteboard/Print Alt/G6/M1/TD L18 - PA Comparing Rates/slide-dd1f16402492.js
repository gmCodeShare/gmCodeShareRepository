const { text3, media1, text2, separator1, buttonGroup1, ggb1 } = components;

ggb1.updateData({ visible: false });
ggb1.instance.setValue('speed', 1);
text3.updateData({ align: 'center' });
components.media1.updateData({ align: 'center' });
onInit();
function onInit() {
  if (!ggb1.data.init) {
    // set initial states
...
/*
{"compTotals":{"textbox":2,"media":1,"separator":1,"buttongroup":1,"geogebra":1},"stage":"Launch","lessonInfo":"6 M1 TD L18 - PA Comparing Rates","teacherView":true,"layout":"one col"}
*/
