...
ggb1.instance.setValue('movingCenterPoint', 105);
ggb1.instance.setValue('center', 105);
ggb1.instance.setValue('xmin', 94.5);
ggb1.instance.setValue('xmax', 115.5);

onInit();
function onInit() {
  if (!ggb1.data.init) {
    // set initial states
    ggb1.instance.setValue('sliderOptions', 105);
...
function updateRight() {
  if (ggb1.instance.getXcoord('sliderPoint') != 105 && count < 3) {
...
button1.on('click', () => {
  ...
  console.log(count);
  if (count == 1) {
    if (ggb1.instance.getXcoord('sliderPoint') <= 105) {
