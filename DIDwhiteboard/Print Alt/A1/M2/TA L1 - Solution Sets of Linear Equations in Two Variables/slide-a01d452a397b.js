...
/* function showPoints(start, end, vis = true) {
  for (let i = start - 1, L = end - 1; i < L; i++) {
...
/*
{"compTotals":{"table":1,"buttongroup":1,"geogebra":1},"stage":"Learn","lessonInfo":"9 M2 TA L01 - Print Alternate Slide Deck for Solution Sets of Linear Equations in Two Variables","teacherView":true,"layout":"two col"}
*/
