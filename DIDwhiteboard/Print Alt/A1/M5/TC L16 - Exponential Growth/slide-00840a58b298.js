...
slide.on("firstload", () => {
  button2.updateData({ align: "center", visible: false });
  button3.updateData({ align: "center", visible: false });
  button4.updateData({ align: "center", visible: true });
...
/*
{"compTotals":{"geogebra":1,"separator":2,"textbox":7,"button":3},"stage":"Learn","lessonInfo":"9 M5 TC L16 - Print Alternate Slide Deck for Exponential Growth","teacherView":true,"layout":"two col"}
*/
