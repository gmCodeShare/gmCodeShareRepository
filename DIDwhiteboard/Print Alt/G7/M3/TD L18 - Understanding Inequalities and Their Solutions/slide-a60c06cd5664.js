...
function keepGoing() {
  if (
    ...
    ggb1.instance.setValue('pumpCount', ggb1.instance.getValue('pumpCount+1'));
...
/*
{"compTotals":{"geogebra":2,"separator":3,"textbox":2,"buttongroup":1},"stage":"Launch","lessonInfo":"7 M3 TD L18 - PA Understanding Inequalities and Their Solutions","teacherView":true,"layout":"two col"}
*/
