const { textDisplay4, table1, feedback } = components;
...
((register) => {
  ...
  const rankedStudents = register
    ...
    .map(({ data, info }) => {
      ...
      const dif = !!parseFloat(data.estimate)
        ? data.estimate - actualValue
        : id1prevTable.data.goBackString;
      return [
...
/*
{"compTotals":{"textbox":2,"table":1},"stage":"Learn","lessonInfo":"7 M5 TD L19 - Print Alternate Slide Deck for Applying Percent Error (digital)","teacherView":true,"layout":"one col"}
*/
