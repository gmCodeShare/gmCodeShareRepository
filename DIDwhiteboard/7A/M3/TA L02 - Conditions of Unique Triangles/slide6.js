...
const catTypesArr = ['angle', 'angle', 'side'];
//const catDefArr = [(30 * Math.PI) / 180, (65 * Math.PI) / 180, 4];
const catDefArr = [(30 * Math.PI) / 180, (47 * Math.PI) / 180, 4];
...
const angleBoolArr = ['angleAFixed', 'angleBFixed', 'angleCFixed'];
const sideBoolArr = ['segABFixed', 'segBCFixed', 'segACFixed'];
...
const anglesToSetArr = [
  ['fixedAngleBAC', 'fixedAngleCAB', 'currentAngleBAC', 'currentAngleCAB'],
  ['fixedAngleABC', 'fixedAngleCBA', 'currentAngleABC', 'currentAngleCBA'],
  ['fixedAngleACB', 'fixedAngleBCA', 'currentAngleACB', 'currentAngleBCA'],
];
const sidesArr = [
  ['fixedLengthAB', 'fixedLengthBA', 'currentLengthAB', 'currentLengthBA'],
  ['fixedLengthBC', 'fixedLengthCB', 'currentLengthBC', 'currentLengthCB'],
  ['fixedLengthCA', 'fixedLengthAC', 'currentLengthCA', 'currentLengthAC'],
];

const pointOrder = ['A', 'B', 'C'];
...
cat1.on('change', ({ assigned }) => {
  ...
  anglesToSetArr.forEach((el) => {
    ggb1.instance.setVisible(el[2], false);
    ggb1.instance.setVisible(el[3], false);
  });
  segOrder.forEach((el) => {
  ...
  //   pointArr.forEach((el) => {
  //     ggb1.instance.unregisterObjectUpdateListener(el);
  //   });
  ...
  //1.1 Redefine all points as coordinates
  pointOrder.forEach((el, index) => {
    let tempX = ggb1.instance.getXcoord(el);
    let tempY = ggb1.instance.getYcoord(el);
    ggb1.instance.evalCommand(`${el}:(${tempX},${tempY})`);
  });

  //2. Check if there is a condition. If not, set triangle to defaults and return.
  if (!hasConditions(catData.platformVals)) {
    setTriangleStyleDefaults();
  ...
  //   if (platformItemsArr[parseInt(catData.orderedItems[0])][0] === 'angle') {
  //     console.log('in angle');
  //     fixedAngleNameArr[primaryIndex].forEach((el, index) => {
  //       console.log(`${index}: ${el}`);
  //       console.log('ggb1.instance.getValue(el) before');
  //       console.log(ggb1.instance.getValue(el));
  //       ggb1.instance.setValue(el, catDefArr[catData.orderCatsAssigned[0]]);
  //       console.log('ggb1.instance.getValue(el) after');
  //       console.log(ggb1.instance.getValue(el));
  //     });
  //     const tertiaryPoint = pointArr[(primaryIndex + 2) % pointArr.length];
  //     console.log('tertiaryPoint');
  //     console.log(tertiaryPoint);
  //     console.log('currentLengthFixedRayArr[primaryIndex]');
  //     console.log(currentLengthFixedRayArr[primaryIndex]);
  //     ggb1.instance.setVisible(currentLengthFixedRayArr[primaryIndex], true);
  //     ggb1.instance.setVisible(fixedAngleNameArr[primaryIndex], true);
  //     ggb1.instance.setVisible('rayACFixed', true);
  //     console.log(
  ...
  //       pointArr[primaryIndex],
  //       firstAssignedAngleFuncPrimary
  //     );
  //     ggb1.instance.registerObjectUpdateListener(
  //       pointArr[(primaryIndex + 1) % pointArr.length],
  //       firstAssignedAngleFuncSecondary
  //     );
  //     ggb1.instance.registerObjectUpdateListener(
  //       pointArr[(primaryIndex + 2) % pointArr.length],
  //       firstAssignedAngleFuncTertiary
  //     );
  //   }
  //   //IF SIDE...
  //   else {
  //     ggb1.instance.registerObjectUpdateListener(
  //       pointArr[primaryIndex],
  //       firstAssignedSideFuncPrimary
  //     );
  //     ggb1.instance.registerObjectUpdateListener(
  //       pointArr[(primaryIndex + 1) % pointArr.length],
  //       firstAssignedSideFuncSecondary
  //     );
  //     ggb1.instance.registerObjectUpdateListener(
  //       pointArr[(primaryIndex + 2) % pointArr.length],
  //       firstAssignedSideFuncTertiary
  //     );
  //   }

  /*
  UNSURE IF THE FOLLOWING IS NECESSARY
  angleBoolArr.forEach((el) => {
    ggb1.instance.setValue(el, false);
  });
  sideBoolArr.forEach((el) => {
    ggb1.instance.setValue(el, false);
  });
  */
...
function setTriangleStyleDefaults() {
  //set all segments to dotted lines
  //set all angles to non-decorated
}
...
function case100(
  ...
  ggb1.instance.setValue(
    fixedAngleNameArr[primaryIndex][0],
...
function case120(
  ...
  ggb1.instance.setValue(
    fixedAngleNameArr[primaryIndex][1],
    2 * Math.PI - catDefArr[catData.orderCatsAssigned[0]]
  );
  ggb1.instance.setValue(
    fixedAngleNameArr[(primaryIndex + 1) % pointArr.length][0],
    catDefArr[catData.orderCatsAssigned[1]]
  );
  ggb1.instance.setValue(
    fixedAngleNameArr[(primaryIndex + 1) % pointArr.length][1],
...
function case130(
  ...
  ggb1.instance.setValue(
    fixedAngleNameArr[(primaryIndex + 2) % pointArr.length][0],
    catDefArr[catData.orderCatsAssigned[1]]
  );
  ggb1.instance.setValue(
    fixedAngleNameArr[(primaryIndex + 2) % pointArr.length][1],
    2 * Math.PI - catDefArr[catData.orderCatsAssigned[1]]
  );
  ggb1.instance.evalCommand(
...
function case123(
  ...
  case120(primaryIndex, primaryPoint, secondaryPoint, tertiaryPoint, catData);
}
...
function case132(
  ...
  case130(primaryIndex, primaryPoint, secondaryPoint, tertiaryPoint, catData);
}
