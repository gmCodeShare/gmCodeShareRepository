...
autorun(() => {
  ...
  if (highlightTimer > 3.1 && growthTimer == 1) {
...
button3.on("click", () => {
  ...
  ggb1.instance.setValue("timeGrowthB", 1);
  ggb1.instance.setValue("timeGrowthC", 1);
  ggb1.instance.setValue("timeHighlight", 3.14);
  ggb1.instance.setValue("secondQuestion", true);
});
...
button1.on("click", () => {
  ...
  ggb1.instance.setValue("showCsquare", false);
