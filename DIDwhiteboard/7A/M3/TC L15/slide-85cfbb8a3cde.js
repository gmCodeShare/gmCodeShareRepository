...
autorun(() => {
  ...
  let highlightTimerB = ggb1.innerData["timeHighlightB"];
  let growthTimer = ggb1.innerData["timeGrowthB"];
  if (growthTimer == 1 && highlightTimer == 0 && highlightTimerB > 3.1) {
    ggb1.instance.setValue("timeHighlightB", 0);
    ggb1.instance.setAnimating("timeHighlightB", true);
    ggb1.instance.startAnimation();
  }
  if (growthTimer == 1 && highlightTimer > 3.1) {
    ggb1.instance.setAnimating("timeHighlightB", false);
