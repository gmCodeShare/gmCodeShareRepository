...
buttonGroup2.on('click:1', () => {
  ...
  if (!(round(low ** 2, roundingPlace) < hypotSquared) || !(hypotSquared < round(high ** 2, roundingPlace))) {
    text6.updateData({ visible: true, text: 'Not yet. Determine the two consecutive hundredths that make the inequalities true.' });
    ggb2.instance.setFixed('DragLeft', false, true);
    ggb2.instance.setFixed('DragRight', false, true);
  }
  // if inequality is true but interval too large
    ...
    text6.updateData({ visible: true, text: 'Your inequality is true but the left and right values are not consecutive hundredths.' });
    ggb2.instance.setFixed('DragLeft', false, true);
    ggb2.instance.setFixed('DragRight', false, true);
  }
