const {
  ...
  feedback,
  text4,
  cc_submit_66df837328d5_textbox1: text1,
  cc_submit_66df837328d5_input1: input1,
  cc_submit_66df837328d5_button1: button1,
  separator3,
  cc_submit_7a29e3f6b791_textbox1: text2,
  cc_submit_7a29e3f6b791_input1: input2,
  cc_submit_7a29e3f6b791_button1: button2,
  separator4,
  cc_submit_378e113621ae_textbox1: text3,
  cc_submit_378e113621ae_input1: input3,
  cc_submit_378e113621ae_button1: button3,
} = components;
...
// let data = getFromSlide(`slide-4f8940ede44c`, "ggb1");
...
button1.on('click', () => {
  ...
  text2.updateData({
    text: `What is $3(w+4)$ when $w$ equals $${input1.data.text}$?`,
  });
});
...
button2.on('click', () => {
  ...
  text3.updateData({
    text: `What is $3w+12$ when $w$ equals $${input1.data.text}$?`,
  });
});
