...
button2.on('click', () => {
  ...
  // if(ggb1.instance.getValueString("emptyInt1")!=="20w" || ggb1.instance.getValueString("emptyInt2")!=="15" || ggb1.instance.getValueString("emptyL1")!="-5" ||
  // ggb1.instance.getValueString("emptyT1")!=="-4w" || ggb1.instance.getValueString("emptyT2")!=="-3"){
