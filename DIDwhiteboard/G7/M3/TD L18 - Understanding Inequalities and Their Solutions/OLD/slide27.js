const {
  ...
  cc_sharewithclass_127e1aa6645a_textbox1: shareAnswers1,
} = components;
...
buttonGroup2.on("click:1", () => {
  ...
  ggb1.instance.setValue("shownVal", 7.5);
  buttonClickFunction();
});
buttonGroup2.on("click:2", () => {
  ...
  ggb1.instance.setValue("shownVal", 7.9);
  buttonClickFunction();
});
buttonGroup2.on("click:3", () => {
  ...
  ggb1.instance.setValue("shownVal", 8);
  buttonClickFunction();
});
buttonGroup2.on("click:4", () => {
  ...
  ggb1.instance.setValue("shownVal", 8.1);
  buttonClickFunction();
});
...
buttonGroup3.on("click:1", () => {
  ...
  ggb1.instance.setValue("shownVal", 8.5);
  buttonClickFunction();
});
buttonGroup3.on("click:2", () => {
  ...
  ggb1.instance.setValue("shownVal", 9);
  buttonClickFunction();
});
buttonGroup3.on("click:3", () => {
  ...
  ggb1.instance.setValue("shownVal", 10);
  buttonClickFunction();
});
buttonGroup3.on("click:4", () => {
  ...
  ggb1.instance.setValue("shownVal", 12);
  buttonClickFunction();
});
