...
buttonGroup1.on("click:2", () => {
  ...
  ggb1.instance.setValue("shownVal", -6);
  buttonClickFunction();
});
...
buttonGroup1.on("click:4", () => {
  ...
  ggb1.instance.setValue("shownVal", -3.5);
  buttonClickFunction();
});
...
buttonGroup2.on("click:1", () => {
  ...
  ggb1.instance.setValue("shownVal", -3.1);
  buttonClickFunction();
});
...
buttonGroup2.on("click:3", () => {
  ...
  ggb1.instance.setValue("shownVal", -2.9);
  buttonClickFunction();
});
buttonGroup2.on("click:4", () => {
  ...
  ggb1.instance.setValue("shownVal", -2.5);
  buttonClickFunction();
});
