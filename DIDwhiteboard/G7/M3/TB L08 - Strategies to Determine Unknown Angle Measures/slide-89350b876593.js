const {
  ...
  ggb2,
  feedback,
  cc_submit_0272cc25d721_textbox1: text1,
  cc_submit_0272cc25d721_input1: input1,
  cc_submit_0272cc25d721_button1: button1,
  separator2,
  cc_sharewithclass_9715150952c6_textbox1: text2,
  cc_sharewithclass_9715150952c6_input1: input2,
  cc_sharewithclass_9715150952c6_button1: button2,
...
ggb1.instance.setValue('showBracket', true);
...
ggb2.instance.setCoords(
  'CenterPoint',
  data2.innerData['CenterPoint'][0],
  data2.innerData['CenterPoint'][1]
);
...
ggb2.instance.setValue('eq2', data2.innerData['eq2']);
...
/*
{"compTotals":{"geogebra":2,"separator":2,"textbox":1,"submit":1,"sharewithclass":1},"stage":"Learn","lessonInfo":"7 M3 TB L08 - Strategies to Determine Unknown Angle Measures","teacherView":false,"layout":"two col"}
*/
