...
ggb1.instance.registerObjectUpdateListener('β', update);
...
ggb1.instance.evalCommand(`SetValue(D,Point(l1,${data.innerData['path']}))`);
/*ggb1.instance.evalCommand(`D=Point(l1,${data.innerData["path"]})`);
console.log(data.innerData["path"]);*/
