...
cc_sharewithclass_266dde9717be_textbox1.updateData({
  text: `Here are your $${num}$ pulls. \n\nBased on your results, what is an estimate for the theoretical probability of pulling a blue chip from bucket A?`,
});
