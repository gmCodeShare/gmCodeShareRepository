const { ggb1, feedback1, text1, button1, Separator1, table1 } = components;
...
button1.on('click', () => {
  ...
  if (ggb1.instance.getValue('count') == 10) {
    ...
    //table1.updateCell(9,2,{value: `$\\frac${num10}{10}=${num20}$`});
...
/*
{"compTotals":{"geogebra":1,"textbox":2,"button":1,"separator":1,"table":1},"stage":"Learn","lessonInfo":"7 M6 TB L08 - Picking Blue","teacherView":false,"layout":"two col"}
*/
