...
function promptSet() {
  if (ggb1.innerData['load'] == 0.1) {
    ...
    if (ggb1.innerData['speed'] == 0.5) {
      text1.updateData({
        text: `There are $20$ emojis hidden behind the squares. You have $20$ seconds to memorize their locations.\n\nWhen you’re ready, press start.`,
      });
    }
  }
}
...
/*
{"compTotals":{"geogebra":1,"textbox":3,"button":1},"stage":"Launch","lessonInfo":"7 M6 TD L19 - Memory Games","teacherView":false,"layout":"two col"}
*/
