const {
  ...
  cc_submit_f7bb5587866d_button1: subminButton1,
  text1,
} = components;

ggb1.instance.setErrorDialogsActive(false);

subminButton1.updateData({ align: 'right' });
...
autorun(() => {
  ...
  subminButton1.updateData({ disabled: false, text: 'Submit' });
  ggb1.instance.evalCommand('UpdateConstruction()');
});

subminButton1.on('click', () => {
  ggb1.instance.evalCommand('UpdateConstruction()');
