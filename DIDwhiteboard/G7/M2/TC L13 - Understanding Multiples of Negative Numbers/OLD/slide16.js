...
// ggb1.instance.setValue("state2", true);
...
const id1 = `slide-4a2d03c36826`;
let studentInput =
  getFromSlide(id1, "cc_submit_90db8dd1d5ec_input1.data.text", "") || "";
...
const sketches =
  getFromSlide("slide-10476c759aed", "ggb1.data.doodles", []) || [];
