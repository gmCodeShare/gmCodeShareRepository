...
function onInit() {
  if (!ggb1.data.init) {
    ...
    ggb1.instance.setValue('clickCount', 101);
...
/*
{"compTotals":{"table":1,"geogebra":1,"uploaded-image":1,"textbox":2,"button":1,"separator":1,"sharewithclass":1},"stage":"Learn","lessonInfo":"7 M1 TC L15 - Scale Drawings","teacherView":false,"layout":"two col"}
*/
