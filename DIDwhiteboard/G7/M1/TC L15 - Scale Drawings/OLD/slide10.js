const { ggb1, button1, text1, table1 } = components;
...
button1.on("click", () => {
  ...
  switch (ggb1.instance.getValue("clickCount")) {
    case 0:
      text1.updateData({
        text: "Place the pink segment somewhere on the original figure to measure the distance between two points. Try to choose something specific, but also something you don't think others will choose.\n\nWhen ready, click Try it.",
      });
      break;
    case 1:
      table1.updateCell(0, 1, {
        value:
          Math.round(
            ggb1.instance.getValue("scaleFactor") *
              Math.round(ggb1.instance.getValue("origSegLength1") * 10) *
              10
          ) / 100,
        editable: false,
      });
      ...
      text1.updateData({
        text: "Notice the lengths of the two segments. Is there any relationship between those two lengths?\n\nTake a look, and when ready, click Try it again to test out a new segment.",
      });
      break;
    case 2:
      ...
      text1.updateData({
        text: "Now place the yellow segment somewhere on the original figure to measure the distance between two points. Try to choose something specific, but also something you don't think others will choose.\n\nWhen ready, click Try it.",
      });
      break;
    case 3:
      table1.updateCell(1, 1, {
        value:
          Math.round(
            ggb1.instance.getValue("scaleFactor") *
              Math.round(ggb1.instance.getValue("origSegLength2") * 10) *
              10
          ) / 100,
        editable: false,
      });
    ...
    case 4:
      ...
      text1.updateData({
        text: "Now place the green segment somewhere on the original figure to measure the distance between two points. Try to choose something specific, but also something you don't think others will choose.\n\nWhen ready, click Try it.",
      });
      break;
    case 5:
      table1.updateCell(2, 1, {
        value:
          Math.round(
            ggb1.instance.getValue("scaleFactor") *
              Math.round(ggb1.instance.getValue("origSegLength3") * 10) *
              10
          ) / 100,
        editable: false,
      });
      ...
      text1.updateData({
        text: "When ready, click Try it to look at all three pairs of segments at the same time.",
      });
      break;
    case 6:
