/* -- autoCom slideId: slide-8beedd411f8c - autoCom slideId -- */

const { ggb1, feedback1, text1, text2, table1, text3, buttonGroup1 } =
  components;
...
autorun(() => {
  ...
  if ((time >= 100 / constOfProp && !stopTime) || (coins == 100 && !stopTime)) {
  ...
  if (time > 0 && !validateRow5) {
    ...
    text3.updateData({
      visible: true,
      text: `Time: $${a5}$ seconds
        
      Coins sorted: $${enteredCoinsA5}$`,
    });
  }
  if (time > 0 && !validateRow6) {
    ...
    text3.updateData({
      visible: true,
      text: `Time: $${enteredTimeB6}$ seconds
...
buttonGroup1.on('click:2', () => {
  ...
  table1.updateCell(3, 0, { className: '', editable: true });
  table1.updateCell(3, 1, { className: '', editable: false });
  table1.updateCell(4, 0, { className: '', editable: false });
  table1.updateCell(4, 1, { className: '', editable: true });
  //  table1.updateCell(5, 0, { className: '', editable: false });
  //  table1.updateCell(5, 1, { className: '', editable: true });
...
/*
start slide search -- {"lessonInfo":"7 M1 TA L01 - An Experiment with Ratios and Rates","compTotals":{"textbox":4,"geogebra":1,"buttongroup":1,"table":1},"textboxInfo":{"align":["center","left"],"disabled":[false],"labelForRelation":[],"style_theme":["default"],"text":["Time: $0$ seconds\n\nCoins sorted: $0$","# Machine D","Complete the table.",""],"visible":[true,false],"position":["[0,1]","[0,0]"],"sizeConfig_value":["container"]},"ggbInfo":{"materialId":["wqvpysyc"],"widgetSize":["default"],"fixed":[false],"disabled":[false],"visible":[true],"position":["[0,0]"]},"buttongroupInfo":{"disabled":[false],"text":["Reset","Test Your Predictions"],"position":["[0,1]"],"sizeConfig_value":["container"]},"tableOrigInfo":{"columns":[2],"rows":[6],"columnWidth":[null],"columnsEqualWidth":["Array is Undefined"],"canAddColumns":[false],"canAddRows":[false],"columns_cell_alignment":["center"],"columns_cell_editable":[false],"columns_cell_numberOfLines":["1"],"columns_cell_type":["singleline"],"columns_cell_value":["Number of Coins Sorted","Number of Seconds"],"rows_cell_alignment":["center"],"rows_cell_editable":[true,false],"rows_cell_inputType":["text"],"rows_cell_math":[true],"rows_cell_numberOfLines":["1"],"rows_cell_type":["singleline"],"rows_cell_value":["10","99","18","","12","9","1.5"],"disabled":[false],"position":["[0,1]"]},"imageInfo":{"imagesMissingAltText":0},"storedGGBMaterialIds":["wqvpysyc - 2022-01-20T16:57:24.855Z"],"stage":"Learn","teacherView":false,"layout":"two col"} -- end slide search
*/
