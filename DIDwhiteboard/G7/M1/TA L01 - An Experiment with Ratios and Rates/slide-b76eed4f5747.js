/* -- autoCom slideId: slide-b76eed4f5747 - autoCom slideId -- */
...
autorun(() => {
  ...
  if (time > 0 && !validateRow7) {
    ...
    text3.updateData({
      visible: true,
      text: `Time: $${enteredTimeB7}$ seconds
...
/*
start slide search -- {"lessonInfo":"7 M1 TA L01 - An Experiment with Ratios and Rates","compTotals":{"textbox":4,"geogebra":1,"buttongroup":1,"table":1},"textboxInfo":{"align":["center","left"],"disabled":[false],"labelForRelation":[],"style_theme":["default"],"text":["Time: $0$ seconds\n\nCoins sorted: $0$","# Machine A","Complete the table.",""],"visible":[true,false],"position":["[0,1]","[0,0]"],"sizeConfig_value":["container"]},"ggbInfo":{"materialId":["wqvpysyc"],"widgetSize":["default"],"fixed":[false],"disabled":[false],"visible":[true],"position":["[0,0]"]},"buttongroupInfo":{"disabled":[false],"text":["Reset","Test Your Predictions"],"position":["[0,1]"],"sizeConfig_value":["container"]},"tableOrigInfo":{"columns":[2],"rows":[7],"columnWidth":[null],"columnsEqualWidth":["Array is Undefined"],"canAddColumns":[false],"canAddRows":[false],"columns_cell_alignment":["center"],"columns_cell_editable":[false],"columns_cell_numberOfLines":["1"],"columns_cell_type":["singleline"],"columns_cell_value":["Number of Coins Sorted","Number of Seconds"],"rows_cell_alignment":["center"],"rows_cell_editable":[true,false],"rows_cell_inputType":["text"],"rows_cell_math":[true],"rows_cell_numberOfLines":["1"],"rows_cell_type":["singleline"],"rows_cell_value":["12","100","8","80","","2","20","4"],"disabled":[false],"position":["[0,1]"]},"imageInfo":{"imagesMissingAltText":0},"storedGGBMaterialIds":["wqvpysyc - 2022-01-20T16:57:24.855Z"],"stage":"Learn","teacherView":false,"layout":"two col"} -- end slide search
*/
