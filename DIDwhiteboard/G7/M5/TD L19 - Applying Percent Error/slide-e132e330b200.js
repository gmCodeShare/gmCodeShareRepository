const { ggb1, feedback1, text1, text2, text4, input1, text3, button1 } =
  components;
...
button1.on('click', () => {
  ...
  if (num.value < 0 || num.error) {
    ...
    utils.RTS.sendData('slide-e132e330b200.input1', {
      estimate: num.value,
      actualValue,
    });
  }
...
/*
{"compTotals":{"geogebra":1,"textbox":5,"input":1,"button":1},"stage":"Learn","lessonInfo":"7 M5 TD L19 - Applying Percent Error (digital)","teacherView":false,"layout":"two col"}
*/
