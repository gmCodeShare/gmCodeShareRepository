const { ggb1, feedback1, text1, table1, button1, separator7, text2 } =
  components;
...
ggb1.instance.setValue('myPercent', 0.65);
...
table1.updateCell(1, 1, {
  value: (origVal2 * (ggb1.instance.getValue('myPercent') * 1000)) / 1000,
});
table1.updateCell(2, 0, { value: origVal3 });
table1.updateCell(3, 1, {
  value: (origVal4 * (ggb1.instance.getValue('myPercent') * 1000)) / 1000,
});

//sets values of percents
table1.updateCell(0, 2, { value: '65\\%' });
table1.updateCell(1, 2, { value: '65\\%' });
table1.updateCell(2, 2, { value: '65\\%' });
table1.updateCell(3, 2, { value: '65\\%' });
