...
const minGiven = 5;
ggb1.updateInnerData({ rad1: minGiven, rad2: 6 });
// ggb1.updateInnerData({ rad1: minGiven, rad2: 5, rad3: 5 });
// ggb1.updateInnerData({ rad1: minGiven, rad2: 5, rad3: 5, rad4: 5 });
ggb1.instance.evalCommand("SetValue(probAngle, 42 deg)"); // angles slides
...
autorun(() => {
  if (controls.current == now + 1 && ggb1.data.sendPoints) {
    utils.RTS.sendData("slide-279bade1ef11", {
      //ggb1.updateData({
