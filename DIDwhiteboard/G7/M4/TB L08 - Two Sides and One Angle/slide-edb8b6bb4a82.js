...
autorun(() => {
  if (controls.current == now + 1 && ggb1.data.sendPoints) {
    utils.RTS.sendData('slide-edb8b6bb4a82', {
...
/*
{"compTotals":{"geogebra":1,"separator":1,"button":1,"textbox":2},"stage":"Learn","lessonInfo":"7 M4 TB L08 - Two Sides and One Angle","teacherView":false,"layout":"two col"}
*/
