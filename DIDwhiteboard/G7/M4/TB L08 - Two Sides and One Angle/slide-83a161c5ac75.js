...
autorun(() => {
  if (controls.current == now + 1 && ggb1.data.sendPoints) {
    utils.RTS.sendData('slide-83a161c5ac75', {
...
/*
{"compTotals":{"geogebra":1,"separator":1,"button":1,"textbox":2},"stage":"Launch","lessonInfo":"7 M4 TB L08 - Two Sides and One Angle","teacherView":false,"layout":"two col"}
*/
