...
buttonGroup1.on('click:1', () => {
  ...
  if (ggb1.instance.getValue('same')) {
    ...
    ggb1.instance.evalCommand(
      `ReadText("Excellent! Try a new position for the boxes.")`
    );
...
/*
{"compTotals":{"geogebra":1,"textbox":2,"buttongroup":1,"separator":1,"sharewithclass":1},"stage":"Launch","lessonInfo":"6 M6 TB L08 - The Mean as a Balance Point","teacherView":false,"layout":"two col"}
*/
