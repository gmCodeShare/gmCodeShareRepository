const {
  ggb1,
  feedback1,
  cc_submit_01b29b430320_textbox1: shareText1,
  cc_submit_01b29b430320_input1: shareInput1,
  cc_submit_01b29b430320_button1: shareButton1,
  Separator3,
  table1,
} = components;
...
function scoreDisplay(a) {
  if (a.type == 'select') {
    for (let i = 0, L = points.length; i < L; i++) {
      ggb1.instance.setColor(points[i], 0, 127, 175);
    }
    ggb1.instance.setColor(a[1], 218, 41, 28);
    if (a.target == 'Atlanta') {
    ...
    ggb1.instance.setValue('showHelp', false);
  }
}

/*
{"compTotals":{"geogebra":1,"textbox":1,"submit":1,"separator":1,"table":1},"stage":"Launch","lessonInfo":"6 M6 TA L04 - Creating a Histogram","teacherView":false,"layout":"two col"}
*/
