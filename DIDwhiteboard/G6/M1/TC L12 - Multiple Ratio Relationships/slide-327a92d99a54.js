const { ggb1, text1, table1, buttonGroup1 } = components;
...
buttonGroup1.on('click:2', () => {
  ...
  ggb1.instance.setValue('redPart2', redNum.value);
...
autorun(() => {
  let entries = [table1.getCell(0, 2).value];
...
/*
{"compTotals":{"geogebra":1,"textbox":1,"table":1,"buttongroup":1},"stage":"Launch","lessonInfo":"6 M1 TC L12 - Multiple Ratio Relationships","teacherView":false,"layout":"two col"}
*/
