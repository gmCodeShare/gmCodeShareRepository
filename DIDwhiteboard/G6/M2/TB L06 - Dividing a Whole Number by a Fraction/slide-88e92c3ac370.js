const {
  ...
  buttonGroup1,
  feedback1,
  cc_submit_bbf930799915_textbox1: submitText1,
  cc_submit_bbf930799915_input1: submitInput1,
  cc_submit_bbf930799915_button1: submitButton1,
  Separator2,
  cc_submit_7f2f19783c58_textbox1: submitText2,
  cc_submit_7f2f19783c58_input1: submitInput2,
  cc_submit_7f2f19783c58_button1: submitButton2,
  Separator3,
  cc_sharewithclass_40cc7722a72a_textbox1: shareText1,
  cc_sharewithclass_40cc7722a72a_input1: shareInput1,
  cc_sharewithclass_40cc7722a72a_button1: shareButton1,
  cc_sharewithclass_40cc7722a72a_studentanswers1,
} = components;
...
function onInit() {
  if (!ggb1.data.init) {
    // set initial states
    ggb1.updateInnerData({ fakeNumer: 1, fakeDenom: 4, A: [5, 0] });
