const {
  ...
  buttonGroup1,
  feedback1,
  cc_submit_898f8343764d_textbox1: submitText1,
  cc_submit_898f8343764d_input1: submitInput1,
  cc_submit_898f8343764d_button1: submitButton1,
  Separator2,
  text1,
} = components;
...
function onInit() {
  if (!ggb1.data.init) {
    ...
    ggb1.updateInnerData({ fakeNumer: 4, fakeDenom: 3, A: [6, 0] });
