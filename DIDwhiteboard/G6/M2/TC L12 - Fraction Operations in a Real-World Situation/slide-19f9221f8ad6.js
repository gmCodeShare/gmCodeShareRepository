...
select1.on('change', ({ selected }) => {
  ...
  for (let i = 0, L1 = decalArray.length; i < L1; i++) {
    ggb1.instance.setValue(decalArray[i], false);
  }
  if (!isNaN(currentSelected)) {
    ggb1.instance.setValue(decalArray[currentSelected], true);
  }
  snap();
});
...
/*
{"compTotals":{"textbox":6,"geogebra":1,"separator":1,"select":1,"button":1},"stage":"Learn","lessonInfo":"6 M2 TC L12 - Fraction Operations in a Real-World Situation","teacherView":false,"layout":"two col"}
*/
