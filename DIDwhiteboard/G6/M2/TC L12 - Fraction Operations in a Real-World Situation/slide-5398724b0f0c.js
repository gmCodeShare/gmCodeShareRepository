...
ggb1.instance.registerObjectUpdateListener('time2', updateRight);
...
function onInit() {
  if (!ggb1.data.init) {
    ...
    ggb2.instance.setValue('sliderMax', 10);
...
text1.updateData({
  text:
    id8PrevInput1.data.hasData &&
    utils.math.evaluateLatex(id8PrevInput1.data.text).value !=
      round(
      ...
      ? `You entered a total weight of $${id8PrevInput1.data.text}$ ounces for your car, which is incorrect. Go back to slide ${id8PrevInput1.data.slideNum} and check your work.`
      : `You entered a total weight of $${id8PrevInput1.data.text}$ ounces for your car.`,
});
    ...
    ggb1.instance.setValue(
      ...
      round(
        weightArray[id1PrevSelect1.data.chosen] +
          ...
          weightPaint +
          id8PrevGGB1.innerData['sliderVal'] * weightDecal +
          ggb2.instance.getValue('sliderVal') * 0.5,
        numOfRoundingDecimals
      )
    );
...
function updateRight() {
  ...
  if (result.value > 6 && ggb1.instance.getValue('time2') >= 0.8) {
...
/*
{"compTotals":{"textbox":10,"bynder-image":1,"uploaded-image":1,"geogebra":2,"button":2,"separator":1,"input":1},"stage":"Learn","lessonInfo":"6 M2 TC L12 - Fraction Operations in a Real-World Situation","teacherView":false,"layout":"two col"}
*/
