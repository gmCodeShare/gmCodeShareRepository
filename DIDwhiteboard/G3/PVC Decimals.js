...
function popul8() {
  ...
  if (click == 1) {
    ...
    for (var popLoop = 0; popLoop < labelTenths; popLoop++) {
      ...
      ggbApplet.setColor("TENTHS" + popLoop, 127, 0, 255);
    ...
    for (var popLoop = 0; popLoop < labelHundredths; popLoop++) {
      ...
      ggbApplet.setColor("HUNDREDTHS" + popLoop, 127, 0, 255);
    ...
    for (var popLoop = 0; popLoop < labelThousandths; popLoop++) {
      ...
      ggbApplet.setColor("THOUSANDTHS" + popLoop, 127, 0, 255);
...
function organize() {
  ...
  for (var popLoop = 0; popLoop < tenthsListLength; popLoop++) {
    ...
    ggbApplet.setColor(pointst[popLoop], 127, 0, 255);
    ggbApplet.setLayer(pointst[popLoop], 0);
    ggbApplet.setVisible(pointst[popLoop], true);
  }
  ...
  for (var popLoop = 0; popLoop < hundredthsListLength; popLoop++) {
    ...
    ggbApplet.setColor(pointsh[popLoop], 127, 0, 255);
    ggbApplet.setLayer(pointsh[popLoop], 0);
    ggbApplet.setVisible(pointsh[popLoop], true);
  }
  ...
  for (var popLoop = 0; popLoop < thousandthsListLength; popLoop++) {
    ...
    ggbApplet.setColor(pointsth[popLoop], 127, 0, 255);
    ggbApplet.setLayer(pointsth[popLoop], 0);
    ggbApplet.setVisible(pointsth[popLoop], true);
  }
}
...
function bundle() {
  ...
  if (pointsth.length < 10 && pointsh.length < 10 && pointst.length < 10 && pointsO.length < 10 && pointsT.length < 10 && pointsH.length < 10 && pointsTH.length < 10 && pointsTT.length < 10 && pointsHT.length < 20) {
...
function moveIt() {
  ...
  if (ggbApplet.getValue("thousandthsBool") == true) {
    for (var i = 1; i <= 10; i++) {
      ...
      ggbApplet.setColor("MovingThousandths" + i, 127, 0, 255);
      if (ggbApplet.getValue("time") > 0.95) {
        ggbApplet.setColor("MovingThousandths" + i, 0, 0, 255);
      }
  ...
  if (ggbApplet.getValue("hundredthsBool") == true) {
    for (var i = 1; i <= 10; i++) {
      ...
      ggbApplet.setColor("MovingHundredths" + i, 127, 0, 255);
      if (ggbApplet.getValue("time") > 0.95) {
        ggbApplet.setColor("MovingHundredths" + i, 0, 0, 255);
      }
      if (ggbApplet.getValue("time") == 1) {
  ...
  if (ggbApplet.getValue("tenthsBool") == true) {
    for (var i = 1; i <= 10; i++) {
      ...
      ggbApplet.setColor("MovingTenths" + i, 127, 0, 255);
      if (ggbApplet.getValue("time") > 0.95) {
        ggbApplet.setColor("MovingTenths" + i, 0, 0, 255);
      }
      if (ggbApplet.getValue("time") == 1) {
