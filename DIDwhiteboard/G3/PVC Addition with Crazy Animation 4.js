...
function organize() {
  ...
  if (ggbApplet.getValue("milsCount4") > 9 || ggbApplet.getValue("hunthouCount4") > 9 || ggbApplet.getValue("tenthouCount4") > 9 || ggbApplet.getValue("thouCount4") > 9 || ggbApplet.getValue("hunsCount4") > 9 || ggbApplet.getValue("tensCount4") > 9 || ggbApplet.getValue("onesCount4") > 9) {
...
function bundle() {
  ...
  if (onesListLength >= 10) {
    ...
    ggbApplet.setValue("tensCount3", 1);
  ...
  if (tensListLength >= 10) {
    ...
    organize();
    //rewrites the algorithm to reflect new pvc
    ggbApplet.setValue("hunsCount3", 1);
  ...
  if (hunsListLength >= 10) {
    ...
    organize();
    //rewrites the algorithm to reflect new pvc
    ggbApplet.setValue("thouCount3", 1);
  ...
  if (thousListLength >= 10) {
    ...
    //  ggbApplet.setVisible("BundlePoint" + bundNum, false);
    //  tenThousList.push("BundlePoint" + bundNum);
    bundNum = bundNum + 1;
    organize();
    //rewrites the algorithm to reflect new pvc
    ggbApplet.setValue("tenthouCount3", 1);
...
function grow() {
  ...
  for (var i = 0; i < 10; i++) {
    ...
    if (ggbApplet.getValue("hunBool") == true) {
      ...
      ggbApplet.setVisible(thousList[thousListLength - 1], true);
      ggbApplet.evalCommand("BundlePoint" + bundNum + "=PointIn(box)");
      ggbApplet.setFixed("BundlePoint" + bundNum, false, false);
      ggbApplet.setPointSize("BundlePoint" + bundNum, 1);
      thousList.push("BundlePoint" + bundNum);
