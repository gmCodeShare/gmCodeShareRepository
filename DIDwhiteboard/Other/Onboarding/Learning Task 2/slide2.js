const {
  ggb1,
  cc_submit_d6725095240f_textbox1: submitText1,
  cc_submit_d6725095240f_button1: submitButton1,
  cc_sharewithclass_a5706b54d7be_textbox1: shareText1,
  cc_sharewithclass_a5706b54d7be_input1: shareInput1,
  cc_sharewithclass_a5706b54d7be_button1: shareButton1,
} = components;
...
const id1 = 'slide-7d0e003f489b';

const id1PrevGGB1 = getPrevGGB(id1, 'ggb1', { dragPointHeight: 4 });

const id1PrevInput1 = getPrevInput(id1, 'cc_submit_b67dce70ab52_input1');
const id1PrevInput2 = getPrevInput(id1, 'cc_submit_9c7de0f560a6_input1');

ggb1.instance.setValue(
  'dragPointHeight',
  id1PrevGGB1.innerData['dragPointHeight']
);
