...
console.log(utils.getFromSlide(id1, 'ggb1.innerData.'));
...
function getPrevGGB(slideID, compName = 'ggb1', innerData, storageComp = '') {
  ...
  // get previous data
  let prevGGB = utils.getFromSlide(slideID, compName, defGGB);
  // check previous data
