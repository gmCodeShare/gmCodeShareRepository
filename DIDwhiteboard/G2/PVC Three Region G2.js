...
function scatter() {
    ...
    for (var j = 0; j < Math.floor(Number / 10); j++) {
        ...
        for (var i = 0; i < Number; i++) {
            ...
            ggbApplet.evalCommand("OnesPoint" + pseudoJ + i + "=(0,0)");
            //randomizes those stick centers
            ggbApplet.setCoords("OnesPoint" + pseudoJ + i, Math.floor(Math.random() * 11), Math.floor(Math.random() * 11));
            //creates randomly-oriented sticks, makes them tan, and makes them thick
            ggbApplet.evalCommand("rand" + i + "=Random()");
            ggbApplet.evalCommand("OnesStick" + i + "=Segment(OnesPoint" + pseudoJ + i + "+(rand" + i + ",1 - rand" + i + "^2),OnesPoint" + pseudoJ + i + "-(rand" + i + ",1 - rand" + i + "^2))");
            ...
            ggbApplet.evalCommand("CloseSnapPoint" + j + i + "=ClosestPoint(SnapPointList" + j + ",OnesPoint" + pseudoJ + i + ")");
...
function organize() {
    ...
    for (var i = 0; i < Number; i++) {
        ...
        ggbApplet.evalCommand("OnesStick" + i + "=Segment(OnesPoint" + pseudoJ + i + "+(0,1),OnesPoint" + pseudoJ + i + "-(0,1))");
        ggbApplet.setColor("OnesStick" + i, 153, 51, 0);
        ggbApplet.setLineThickness("OnesStick" + i, 13);
    }
    //sets visibility of buttons
...
function reset() {
    ...
    for (var i = 0; i < Number; i++) {
        ...
        ggbApplet.deleteObject("OnesPoint" + pseudoJ + i);
